...
public class Monopoly {
	...
	static PropertyCard ReadingRailroad = new PropertyCard(200, 100, 0, 25, 50, 100, 200, 0, "Reading Railroad", 5, 0,
			0, null);
	static PropertyCard PennsylvaniaRailroad = new PropertyCard(200, 100, 0, 25, 50, 100, 200, 0,
			"Pennsylvania Railroad", 15, 0, 0, null);
	static PropertyCard BORailroad = new PropertyCard(200, 100, 0, 25, 50, 100, 200, 0, "B & O Railroad", 25, 0, 0,
			null);
	static PropertyCard ShortLineRailroad = new PropertyCard(200, 100, 0, 25, 50, 100, 200, 0, "Short Line Railroad",
			35, 0, 0, null);
	...
	static PropertyCard ElectricCompany = new PropertyCard(150, 75, 0, 0, 0, 0, 0,
			0, "Electric Company", 12, 0, 0, null);
	static PropertyCard WaterWorks = new PropertyCard(150, 75, 0, 0, 0, 0, 0, 0,
			"Water Works", 28, 0, 0, null);
	...
	public static void rollingOption1(Player p) {
		...
		((PropertyCard) Monopoly.gameBoard.get(12)).setHouseRent(utilityValue);
		((PropertyCard) Monopoly.gameBoard.get(28)).setHouseRent(utilityValue);

	}

public static void utilityCheck(Player player) {
		
		int utilityCount = 0;
		if (player.playerProperties.contains(Monopoly.gameBoard.get(12))) {

			utilityCount++;

		}

		if (player.playerProperties.contains(Monopoly.gameBoard.get(28))) {
		...
		if (player.playerProperties.contains(Monopoly.gameBoard.get(12))) {
			...
			((PropertyCard) Monopoly.gameBoard.get(12)).setHouseCount(utilityCount);

		}

		if (player.playerProperties.contains(Monopoly.gameBoard.get(28))) {

			((PropertyCard) Monopoly.gameBoard.get(28)).setHouseCount(utilityCount);
		...
		superLoop: while (true) {
			...
			while (true) {
				...
				if (option == 1) {
					...
					System.out.println(firstPlayer.playerName + " has rolled " + Monopoly.rollNumb + " with "
							+ "dice1 = " + firstPlayer.dice1 + " dice2 = " + firstPlayer.dice2);
					if (firstPlayer.goJail()) {

						if (firstPlayer.getOutOfJailFree > 0) {
							System.out.println(
									"You can use GET OUT OF JAIL FREE CARD to get out of jail;\n press 1 to use a card\n press any other number to skip");
						...
						System.out.println(firstPlayer.playerName + " is in jail for " + (3 - firstPlayer.jailCounter)
								+ " round!");
					...
					if (rolling.rollDouble(firstPlayer)) {
						...
						if (rolling.tripleDouble(firstPlayer)) {
							firstPlayer.goJail();
							System.out.println(firstPlayer.playerName
									+ " has rolled 3 times Double in a row and sent to jail\nTurn ends\n");
							break;
						}
						System.out.println(firstPlayer.playerName + " has rolled " + (3 - firstPlayer.doubleCount)
								+ " Double and you will need to roll again");
					}
					playerPosition(firstPlayer, secondPlayer);
			...
			System.out.println(secondPlayer.playerName + " has $" + secondPlayer.playerAccount);
			...
			while (true) {
				...
				if (option == 1) {
					...
					System.out.println(secondPlayer.playerName + " has rolled " + Monopoly.rollNumb + " with "
							+ "dice1 = " + secondPlayer.dice1 + " dice2 = " + secondPlayer.dice2);
					if (secondPlayer.goJail()) {
						if (secondPlayer.getOutOfJailFree > 0) {
							System.out.println(
									"You can you GET OUT OF JAIL FREE CARD to get out of jail;\n Press 1 to use a card\n press any other number to skip");
							option = scanner.nextInt();
							if (option == 1) {
								System.out.println("You released from jail");
						...
						System.out.println(secondPlayer.playerName + " is in jail for " + (3 - secondPlayer.jailCounter)
								+ " round!");
					...
					if (rolling.rollDouble(secondPlayer)) {
						...
						if (rolling.tripleDouble(secondPlayer)) {
							...
							secondPlayer.goJail();
							System.out.println(
									secondPlayer.playerName + " Rolled 3 times Double and sent to jail\nTurn ends\n");
							break;
						}
						System.out.println(secondPlayer.playerName + " has rolled " + (3 - secondPlayer.doubleCount)
								+ " times Double and you will need to roll again|");
					}
	...
	public static void chance(Player p1, Player p2) {
		...
		if (n == 4) {
			...
			p1.position = p1.position - 3;
			System.out.println(p1.position);
			Monopoly.landOnSpace(p1, p2, p1.position);
	...
	public static void communityChest(Player p1, Player p2) {
		...
		public static void railroadCheck(Player player) {

		int railroadCount = 0;

		if (player.playerProperties.contains(Monopoly.gameBoard.get(5))) {

			railroadCount++;

		}

		if (player.playerProperties.contains(Monopoly.gameBoard.get(15))) {

			railroadCount++;

		}

		if (player.playerProperties.contains(Monopoly.gameBoard.get(25))) {

			railroadCount++;

		}

		if (player.playerProperties.contains(Monopoly.gameBoard.get(35))) {
		...
		if (player.playerProperties.contains(Monopoly.gameBoard.get(5))) {
			...
			((PropertyCard) Monopoly.gameBoard.get(5)).setHouseCount(railroadCount);

		}

		if (player.playerProperties.contains(Monopoly.gameBoard.get(15))) {

			((PropertyCard) Monopoly.gameBoard.get(15)).setHouseCount(railroadCount);

		}

		if (player.playerProperties.contains(Monopoly.gameBoard.get(25))) {

			((PropertyCard) Monopoly.gameBoard.get(25)).setHouseCount(railroadCount);

		}

		if (player.playerProperties.contains(Monopoly.gameBoard.get(35))) {

			((PropertyCard) Monopoly.gameBoard.get(35)).setHouseCount(railroadCount);
