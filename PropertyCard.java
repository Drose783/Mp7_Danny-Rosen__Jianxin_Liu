...
public class PropertyCard extends Card {
	...
	public PropertyCard(int cost, int mortgageValue, int defaultRent, int houseRent1, int houseRent2, int houseRent3,
			int houseRent4, int hotelRent, String propertyName, int boardNumber, int houseCost, int grouping,
			String colorGroup) {
	...
	public void setHouseRent(int rent) {
